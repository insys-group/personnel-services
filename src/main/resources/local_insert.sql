...
insert into TRAINING(id, name, progress_type, address_id, is_online, start_date, end_date) values(1, 'Pivotal training', 'NOT_STARTED', 1, FALSE, '2017-02-03', '2017-02-10');

insert into TRAINING_TASK(id, name, is_completed, training_id) values (1, 'Training Task', false, 1);
