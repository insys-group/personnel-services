...
insert into ADDRESS(id, address_1 , city , state, zip_code, version) values(9, '23 1st St', 'Secaucus', 'NJ', '09877', 1);
insert into ADDRESS(id, address_1 , city , state, zip_code, version) values(10, '11 Independance Ave', 'Pittsburg', 'PA', '09327', 1);
