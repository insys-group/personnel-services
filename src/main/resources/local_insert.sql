...
insert into Role(id, name, skill, version) values(8, 'Mobile Developer ios', 'Objective c, Swift', 1);
insert into Role(id, name, skill, version) values(9, 'Web Developer', 'Angular, HTML, Java Script', 1);
insert into Role(id, name, skill, version) values(10, 'Full Stack Developer', 'java, Swift, C', 1);
insert into Role(id, name, skill, version) values(11, 'Mobile Developer Android', 'java', 1);

insert into ROLE_SKILL(ROLE_ID) values (8 );
insert into ROLE_SKILL(ROLE_ID) values (9 );
insert into ROLE_SKILL(ROLE_ID) values (10 );
insert into ROLE_SKILL(ROLE_ID) values (11 );
